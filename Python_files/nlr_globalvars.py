...
products_all=('z','a','m','h','r','e','l','v','s','w','p','k','c','d','x','q','t','y','i')
#i_p = import_products
i_p={'z':'z','r':'z','v':'v','s':'v','w':'w','d':'d','p':'p','k':'k','c':'c','x':'x','q':'q','t':'t','y':'y','i':'i','e':'z','a':'z','m':'z','h':'z','l':'z'}
...
productnames={'z':'Z','a':'PCAPPI','m':'Zmax','h':'CMH','r':'RI','v':'V','s':'SRV','w':'W','p':'PhiDP','k':'KDP','c':'CC','x':'LDR','d':'ZDR','e':'ETH','l':'VIL','q':'SQI','t':'CCOR','y':'CPA','i':'CI'}
productnames_cmaps={'z':'Z','a':'PCAP','m':'Zmax','h':'CMH','r':'RI','v':'V','s':'SRV','w':'W','p':'PhiDP','k':'KDP','c':'CC','x':'LDR','d':'ZDR','e':'ETH','l':'VIL','q':'SQI','t':'CCOR','y':'CPA','i':'CI'}
productnames_cmapstab={'z':'Reflectivity','a':'Pseudo CAPPI','m':'Maximum reflectivity','h':'Center of mass height','r':'Rain intensity','v':'Velocity','s':'Storm-relative velocity','w':'Spectrum width','p':'Differential phase','k':'Specific differential phase','c':'Correlation coefficient','x':'Linear depolarisation ratio','d':'Differential reflectivity','e':'Echo top height','l':'Vertically integrated liquid','q':'Signal quality index','t':'Clutter correction','y':'Clutter phase alignment','i':'Clutter indicator'}
productunits_default={'z':'dBZ','a':'dBZ','m':'dBZ','h':'km','r':'mm/h','v':'kts','s':'kts','w':'kts','p':u'\u00b0','k':u'\u00b0'+'/km','c':'%','x':'','d':'dB','e':'km','l':'kg/m\u00B2','q':'','t':'dB','y':'','i':'dB'}
...
products_data_nbits={'z':8,'a':8,'m':8,'h':8,'e':8,'l':16,'r':16,'v':16,'s':16,'w':8,'c':16,'d':8,'p':16,'k':8,'x':16,'q':16,'t':16,'y':16,'i':16}
...
products_maxrange={'z':[-35.,90.],'a':[-35.,90.],'m':[-35.,90.],'h':[0.,25.],'e':[0.,25.],'l':[0.,500.],'r':[-3.,3.],'v':[-1000.,1000.],'s':[-1000.,1000.],'w':[0.,25.],'c':[0.,100.],'d':[-10.,20.],'p':[0.,360.],'k':[-10.,20.],'x':[-50.,0.],'q':[0,1],'t':[0,10],'y':[0,1],'i':[0,10]}
cmaps_maxrange={'z':[-35.,90.],'a':[-35.,90.],'m':[-35.,90.],'h':[0.,25.],'e':[0.,25.],'l':[0.,200.],'r':[-3.,3.],'v':[-100.,100.],'s':[-100.,100.],'w':[0.,25.],'c':[0.,100.],'d':[-10.,20.],'p':[0.,360.],'k':[-10.,20.],'x':[-50.,0.],'q':[0,1],'t':[0,10],'y':[0,1],'i':[0,10]}
...
products_with_tilts=('z','v','s','w','p','d','k','c','x','q','t','y','i')
